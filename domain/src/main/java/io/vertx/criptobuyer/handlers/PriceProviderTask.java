...
public class PriceProviderTask implements SynchronizedTask {

  private final Vertx vertx;
  private final PriceProvider priceProvider;
  private static final Logger LOGGER = LoggerFactory.getLogger(PriceProviderTask.class);

  public PriceProviderTask(Vertx vertx, PriceProvider priceProvider) {
    this.vertx = vertx;
